<x-layout>
    <section class="home-section">
        <h1 class="home-title">Welcome to Recycle Reminder
            <i class="fas fa-recycle"></i>
        </h1>
        <div class="caption">
            <h3>We all have at least forgotten once what category of garbage we should have thrown away, right? <br> Well, now no more thanks to our app! </h3>
